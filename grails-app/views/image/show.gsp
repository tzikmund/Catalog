	...
	<body>
		...
		<div id="show-image" class="content scaffold-show" role="main">
			...
			<ol class="property-list image">
				...
				<g:if test="${imageInstance?.fullPath}">
				<li class="fieldcontain">
					<span id="fullPath-label" class="property-label"><g:message code="image.fullPath.label" default="Full Path" /></span>
					
						<span class="property-value" aria-labelledby="fullPath-label"><g:fieldValue bean="${imageInstance}" field="fullPath"/></span>
